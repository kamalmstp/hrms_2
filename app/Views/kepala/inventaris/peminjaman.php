                            ...
                            <tbody>
                                ...
                                <?php foreach ($peminjaman as $row) : ?>
                                    <tr>
                                        ...
                                        <!-- <td>
                                            <a href="/kepala/edit_peminjaman/<?= $row['peminjaman_id']; ?>" class="btn btn-warning btn-xs" type="button"><i class="fa fa-pencil"></i> Edit</a>
    ...
    <div class="modal fade modal-del<?= $row['peminjaman_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="/kepala/peminjaman_del" method="post" class="form-horizontal form-label-left">
    ...
    <div class="modal fade modal-return<?= $row['peminjaman_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="/kepala/peminjaman_return" method="post" class="form-horizontal form-label-left">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
