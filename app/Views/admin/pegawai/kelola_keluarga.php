...
<div class="modal fade modal-add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="/admin/kelola_keluarga_save" method="post" class="form-horizontal form-label-left">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Nama Lengkap
                        </label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Hubungan Keluarga
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="pendidikan" name="pendidikan" class="form-control col-md-7 col-xs-12">
                        </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Jenis Kelamin
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <!-- <input type="text" id="pendidikan" name="pendidikan" class="form-control col-md-7 col-xs-12"> -->
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Tempat Lahir
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="pendidikan" name="pendidikan" class="form-control col-md-7 col-xs-12">
                        </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Tanggal Lahir
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Nomor Telpon
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pendidikan">Email
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="email" id="pendidikan" name="pendidikan" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
