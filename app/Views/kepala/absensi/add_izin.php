            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="/kepala/izin_pegawai_save" enctype="multipart/form-data" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <small>*) File yang diupload boleh file foto (jpg,jpeg,png,gif) <br>dan Document (pdf,doc,docx) <br> dengan ukuran maksimal 2MB</small>
                                </div>
                            </div>
