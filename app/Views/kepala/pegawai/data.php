                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="nav navbar-right panel_toolbox">
                            <a href="/kepala/add_pegawai" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add </a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a target="_blank" href="/kepala/kelola_jabatan/<?= $row['pegawai_id'] ?>"><i class="fa fa-child"></i> Jabatan</a>
                                                    </li>
                                                    <li><a target="_blank" href="/kepala/kelola_pendidikan/<?= $row['pegawai_id'] ?>"><i class="fa fa-graduation-cap"></i> Pendidikan</a>
                                                    </li>
                                                    <li><a target="_blank" href="/kepala/kelola_keluarga/<?= $row['pegawai_id'] ?>"><i class="fa fa-users"></i> Keluarga</a>
                                                    </li>
                                                    <li><a href="/kepala/absensi_detail/<?= $row['pegawai_id'] ?>"><i class="fa fa-calendar"></i> Absensi</a>
                                                    </li>
                                                    <li><a target="_blank" href="/kepala/pegawai_izin_view/<?= $row['pegawai_id'] ?>"><i class="fa fa-table"></i> Izin</a>
                                                    </li>
                                                    <!-- <li class="divider"></li>
                                                    <li><a href="#"><i class="fa fa-folder"></i> View</a>
                                                    </li> -->
                                                </ul>
                                                <a href="/kepala/edit_pegawai/<?= $row['pegawai_id']; ?>" class="btn btn-warning btn-xs" type="button"><i class="fa fa-pencil"></i> Edit</a>
    ...
    <div class="modal fade modal-akun<?= $row['pegawai_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="/kepala/pegawai_akun_create" method="post" class="form-horizontal form-label-left">
    ...
    <div class="modal fade modal-akundel<?= $row['user_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="/kepala/pegawai_akun_delete" method="post" class="form-horizontal form-label-left">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
    ...
    <div class="modal fade modal-del<?= $row['pegawai_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="/kepala/pegawai_del" method="post" class="form-horizontal form-label-left">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
