                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="nav navbar-right panel_toolbox">
                            <!-- <a href="/kepala/add_izin" type="button" class="btn btn-success"><i class="fa fa-plus"></i> Add </a> -->
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['file'] == '') {
                                                ...
                                                <a target="_blank" href="/kepala/file_izin_download/<?= $row['izin_pegawai_id']; ?>" type="button" class="btn btn-info btn-round"> <i class="fa fa-download"></i> </a>
                                            <?php } ?>
                                        </td>
                                        <td>
                                        ...
                                        <!-- <td>
                                            <a href="/kepala/kelola_izin_edit/<?= $row['izin_pegawai_id']; ?>" class="btn btn-warning btn-xs" type="button"><i class="fa fa-pencil"></i> Edit</a>
