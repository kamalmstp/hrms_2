                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['file'] == null) { ?>
                                                <p><i>Kosong</i></p>
                                            <?php } else { ?>
                                                <a target="_blank" href="/kepala/ijazah_download/<?= $row['pend_peg_id']; ?>" type="button" class="btn btn-info btn-round btn-xs"> <i class="fa fa-download"></i> Unduh</a>
                                            <?php } ?>
                                        </td>
...
<div class="modal fade modal-add" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="add" action="/kepala/pendidikan_pegawai_save" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left">
    ...
    <div class="modal fade modal-edit<?= $row['pend_peg_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="edit" action="/kepala/pendidikan_pegawai_update" enctype="multipart/form-data" method="post" class="form-horizontal form-label-left">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
    ...
    <div class="modal fade modal-del<?= $row1['pend_peg_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <form action="/kepala/pendidikan_pegawai_del" method="post" class="form-horizontal form-label-left">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                        </button>
