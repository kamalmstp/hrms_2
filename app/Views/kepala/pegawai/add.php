            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="/kepala/pegawai_save" enctype="multipart/form-data" id="demo-form" method="post">
                            <?= csrf_field(); ?>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="/kepala/data_pegawai" class="btn btn-primary" type="button">Cancel</a>
